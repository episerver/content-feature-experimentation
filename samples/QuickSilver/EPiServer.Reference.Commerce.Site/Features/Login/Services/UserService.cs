    ...
    public class UserService : IDisposable
    {
        ...
        public async Task<CustomerContact> CreateCustomerContact(SiteUser user)
        {
            ...
            if (contact == null)
            {
                ...
                contact.UserId = new MapUserKey().ToTypedString(user.Email); // The UserId needs to be set in the format "String:{email}". Else a duplicate CustomerContact will be created later on.
            }
