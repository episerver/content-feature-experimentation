define([
    ...
    function (dependency, dom, registry, datetime, username, domClass, domStyle, KpiSummaryWidget, KpiSummariesWidget, ConversionPercentTemplate) {
        //"privates"
        ...
        return {
            ...
            renderTestGloballyDisabled: function (testGloballyDisabledNode, detailsNotificationBarNode) {
                ...
                configStore.get().then(function (configValues) {
                    if (!configValues.isEnabled) {
                        domStyle.set(detailsNotificationBarNode, "display", "block");
                        testGloballyDisabledNode.textContent = resources.test_disabled;
                    }
                });
            },
